function filename = Generate_stats(lib,corner,modelname,W,L,m,temperature,VGmax,VDD,VG_Step,VDlin,vdd_sat,wmin,wmax,lmin,lmax,flag_fet,Terminals,shrink,monteruns)
...
filename=['netlist_vth_stats_' corner '.sp'];
